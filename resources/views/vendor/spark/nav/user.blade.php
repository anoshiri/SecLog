                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/transits">Transits</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/transit-types">Transit Types</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/settings/teams/1#/membership">Users</a>
                        </div>
                    </li>
                </ul>
            </div>
