...
<transit-types :types="spark.extra.types" inline-template>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-12">
                <div class="card card-default">
                    ...
                    <div v-if="!editing" class="card-header">Create New Transit Type</div> 
                    <div v-if="editing" class="card-header">Update Transit Type</div> 
            ...
            <div class="col-md-8 col-sm-12">
                <div class="card card-default">
                    <div class="card-header"> Transit Types </div> 
                    <div class="table-responsive">
                        <table class="table table-valign-middle mb-0">
                            ...
                            <tbody>
                                <tr v-if="types.length > 0" v-for="(item, index) in types">
                                    <td>@{{ item.title }}</td>
